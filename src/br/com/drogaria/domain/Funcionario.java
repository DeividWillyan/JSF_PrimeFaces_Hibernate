...
public class Funcionario {
	...
	@Size(min = 1, max = 50, message = "Tamanho invalido para o campo Nome (1 - 50)")
	...
	@Size(min = 1, max = 8, message = "Tamanho invalido para o campo senha (1 - 8)")
	@Column(name = "fun_senha", length = 32, nullable = false)
	private String senha;

	@NotEmpty(message = "O Campo função não pode ser nulo.")
	@Size(min = 1, max = 50, message = "Tamanho invalido para o campo função (1 - 50)")
